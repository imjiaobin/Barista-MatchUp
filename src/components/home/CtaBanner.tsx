    ...
    <section className="relative py-24 px-6 overflow-hidden">
      ...
      >
        ...
        <Link
          ...
          className="inline-flex items-center gap-1.5 px-10 py-4 bg-caramel text-white text-sm md:text-lg rounded-sm tracking-widest uppercase transition-colors duration-200"
        >
